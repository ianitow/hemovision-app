  ...
  return (
    <>
      ...
      <ScrollView className="mt-48 px-12" centerContent="true">
        ...
        ></Input>
        <Input placeholder="Senha" iconName="account-outline" secureTextEntry={true}></Input>
        <Input placeholder="Email" iconName="email-outline" secureTextEntry={true}></Input>
        <Input
        ...
        <Input placeholder="Repetir a senha" iconName="lock-outline" secureTextEntry={true}></Input>
        <View className="flex-row flex items-center my-4">
          <Checkbox value={isChecked} onValueChange={setChecked} color={colors.primary} />
          <Text className="ml-2">
            I accept the{' '}
        ...
        <View className="bottom-0 flex flex-1 mt-6 ">
          <View className="flex flex-1 ">
            ...
            >
              <Text className="text-white uppercase">REGISTRAR</Text>
            </TouchableOpacity>
          </View>
          <View className="flex items-center   py-4" style={{ color: '#6B6B6B' }}>
            <Text className=" ">
              Já possuiuma conta?{' '}
              <Text
