        ...
        <View className="w-full flex px-12   ">
         ...
         <View className="justify-center">
            ...
            <View className="  mt-56">
              ...
              ></Input>
              <Text
                className="ml-auto   text-right w-full font-medium pb-6"
                style={{ color: "#EF4444" }}
              >
                Esqueceu a senha?
              </Text>
            ...
            <View className="mb-4  bottom-0 w-full">
              <View className="flex-row items-center py-4 w-full">
                <View
                  className="flex-1 "
                  style={{ flex: 1, height: 1, backgroundColor: "#C4C4C4" }}
                />
                <View>
                  <Text
                    className="block"
                    style={{ width: 50, textAlign: "center", color: "#C4C4C4" }}
                  >
                    OU
                  </Text>
                </View>
                <View
                  className="flex-1"
                  style={{ height: 1, backgroundColor: "#C4C4C4" }}
                />
              </View>
